...
function FormUpdateComputer({refresh}) {
  ...
  return (
    <div className="w-[49%] flex flex-col border-blue-500 border-solid border rounded-md bg-teal-100 max-md:w-full">
      <SearchComputer
        setComputer={setComputer}
        setFindComputer={setFindComputer}
      />
...
FormUpdateComputer.propTypes = {
  refresh: PropTypes.func.isRequired,
}

export default FormUpdateComputer;
